const exampleProposal = {
  ...
  "payload":{
    ...
    "body":"Due to various YAM versions available, it is affecting the adoption of YAMv3. Thus community should adopt only one latest version which is YAMv3 and define the final date where version 2 conversion to version 3 will end.",
    "choices":[
...
const exampleVote = {
  ...
  "token":"0xAba8cAc6866B83Ae4eec97DD07ED254282f6aD8A",
  "type":"vote",
  "payload":{"proposal":"QmXAZP8tYwX2zZz5EzfxLZUYJt6TM9EmxY1L4qodhZ5zcZ","choice":1}
}`,
  sig:
